...
portalppt.w4 = window(portalppt.ts,start=c(2010,1),end=c(2013,10))
portal4swppt.w4 = window(portal4swppt.ts,start=c(2010,1),end=c(2013,10))
sansimonppt.w4 = window(sansimonppt.ts,start=c(2010,1),end=c(2013,10))
plot(as.vector(portalppt.w4),as.vector(portal4swppt.w4))
model6 = lm(portal4swppt.w4~portalppt.w4)
lines(seq(150),9.5+seq(150)*1.5,col='red')

plot(as.vector(portalppt.w4),as.vector(sansimonppt.w4))
model6a = lm(sansimonppt.w4~portalppt.w4)
lines(seq(150),6+seq(150)*.87,col='red')
...
plot(portalxt.w,portal4swxt.w)
lines(seq(50),seq(50))
model1 = lm(portal4swxt.w~portalxt.w)
lines(seq(50),.2+seq(50)*.88,col='red')
...
plot(portalnt.w,portal4swnt.w)
lines(seq(-15,20),seq(-15,20))
model2 = lm(portal4swnt.w~portalnt.w)
lines(seq(-15,20),-6+seq(-15,20)*.9,col='red')
